...
# function CG_Matrix_Free_GPU_v2(x_GPU,Ap_GPU,b_reshaped_GPU,Nx,Ny;abstol=reltol) # optimized performance
...
#         rsold = rsnew
#         # @show rsold
#         push!(norms,sqrt(rsnew))
#     end
#     # @show num_iter_steps
#     return num_iter_steps, abstol,norms
# end
