...
function matrix_free_HA_GPU_v4(idata_GPU,odata_GPU,odata_GPU_NSWE_tmp,grid_info_GPU,coef_D,Nx,Ny,hx,hy)
    ...
    copyto!(view(odata_GPU,1:4,1:Nx),view(odata_GPU_NSWE_tmp.odata_GPU_N_D2,1:4,1:Nx));
    copyto!(view(odata_GPU,Ny-3:Ny,1:Nx),view(odata_GPU_NSWE_tmp.odata_GPU_S_D2,1:4,1:Nx));
    copyto!(view(odata_GPU,5:Ny-4,1:4),view(odata_GPU_NSWE_tmp.odata_GPU_W_D2,5:Ny-4,1:4));
    copyto!(view(odata_GPU,5:Ny-4,Nx-3:Nx),view(odata_GPU_NSWE_tmp.odata_GPU_E_D2,5:Ny-4,1:4));
    ...
    @inbounds view(odata_GPU,1,1:Nx) .+= view(odata_GPU_NSWE_tmp.odata_GPU_N_P,1,1:Nx)
    @inbounds view(odata_GPU,Ny,1:Nx) .+= view(odata_GPU_NSWE_tmp.odata_GPU_S_P,4,1:Nx)
    @inbounds view(odata_GPU,1:Ny,1:4) .+= view(odata_GPU_NSWE_tmp.odata_GPU_W_P,1:Ny,1:4)
    @inbounds view(odata_GPU,1:Ny,Nx-3:Nx) .+= view(odata_GPU_NSWE_tmp.odata_GPU_E_P,1:Ny,1:4)
